...
namespace Scratch.CoalesceScratch.Data;
...
public class DevelopmentAppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        builder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Scratch.CoalesceScratch;Trusted_Connection=True;TrustServerCertificate=True;");
