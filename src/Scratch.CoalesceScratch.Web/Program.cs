using Scratch.CoalesceScratch.Data;
using Scratch.CoalesceScratch.Data.Auth;
using Scratch.CoalesceScratch.Web;
...
services.AddDbContext<AppDbContext>(options => options
    .UseSqlServer(builder.Configuration.GetConnectionString("coalescescratchdb"), opt => opt
