...
namespace Scratch.CoalesceScratch.Web.Api
{
    ...
    public partial class UserController
        : BaseApiController<Scratch.CoalesceScratch.Data.Models.User, UserParameter, UserResponse, Scratch.CoalesceScratch.Data.AppDbContext>
    {
        public UserController(CrudContext<Scratch.CoalesceScratch.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<Scratch.CoalesceScratch.Data.Models.User>();
        }
        ...
        public virtual Task<ItemResult<UserResponse>> Get(
            ...
            IDataSource<Scratch.CoalesceScratch.Data.Models.User> dataSource)
        ...
        public virtual Task<ItemResult<UserResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<Scratch.CoalesceScratch.Data.Models.User> dataSource,
            IBehaviors<Scratch.CoalesceScratch.Data.Models.User> behaviors)
            ...
            [FromQuery] byte[] etag)
        {
            ...
            var dataSource = dataSourceFactory.GetDataSource<Scratch.CoalesceScratch.Data.Models.User, Scratch.CoalesceScratch.Data.Models.User>("Default");
