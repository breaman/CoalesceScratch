...
namespace Scratch.CoalesceScratch.Web.Api
{
    ...
    public partial class WidgetController
        : BaseApiController<Scratch.CoalesceScratch.Data.Models.Widget, WidgetParameter, WidgetResponse, Scratch.CoalesceScratch.Data.AppDbContext>
    {
        public WidgetController(CrudContext<Scratch.CoalesceScratch.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<Scratch.CoalesceScratch.Data.Models.Widget>();
        }
        ...
        public virtual Task<ItemResult<WidgetResponse>> Get(
            ...
            IDataSource<Scratch.CoalesceScratch.Data.Models.Widget> dataSource)
        ...
        public virtual Task<ItemResult<WidgetResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<Scratch.CoalesceScratch.Data.Models.Widget> dataSource,
            IBehaviors<Scratch.CoalesceScratch.Data.Models.Widget> behaviors)
