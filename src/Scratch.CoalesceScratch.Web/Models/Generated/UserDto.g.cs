...
{
    public partial class UserParameter : GeneratedParameterDto<Scratch.CoalesceScratch.Data.Models.User>
    {
        ...
        /// </summary>
        public override void MapTo(Scratch.CoalesceScratch.Data.Models.User entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override Scratch.CoalesceScratch.Data.Models.User MapToNew(IMappingContext context)
        {
            var entity = new Scratch.CoalesceScratch.Data.Models.User();
            MapTo(entity, context);
            return entity;
        }
    }

    public partial class UserResponse : GeneratedResponseDto<Scratch.CoalesceScratch.Data.Models.User>
    {
        public UserResponse() { }
        ...
        public System.Collections.Generic.ICollection<Scratch.CoalesceScratch.Web.Models.UserRoleResponse> UserRoles { get; set; }

        /// <summary>
        /// Map from the domain object to the properties of the current DTO instance.
        /// </summary>
        public override void MapFrom(Scratch.CoalesceScratch.Data.Models.User obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
            ...
            if ((context.IsInRoleCached("UserAdmin")))
            {
                ...
                if (propValUserRoles != null && (tree == null || tree[nameof(this.UserRoles)] != null))
                {
                    this.UserRoles = propValUserRoles
                        ...
                        .Select(f => f.MapToDto<Scratch.CoalesceScratch.Data.Models.UserRole, UserRoleResponse>(context, tree?[nameof(this.UserRoles)])).ToList();
                }
