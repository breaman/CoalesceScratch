...
{
    public partial class UserInfoParameter : GeneratedParameterDto<Scratch.CoalesceScratch.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(Scratch.CoalesceScratch.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override Scratch.CoalesceScratch.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new Scratch.CoalesceScratch.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<Scratch.CoalesceScratch.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(Scratch.CoalesceScratch.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
