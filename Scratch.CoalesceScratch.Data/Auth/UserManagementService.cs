...
using Scratch.CoalesceScratch.Data.Communication;

namespace Scratch.CoalesceScratch.Data.Auth;

public class UserManagementService(UserManager<User> userManager, IUrlHelper urlHelper, IEmailService emailSender)
{
    ...
    public async Task<ItemResult> SendEmailChangeRequest(User user, string newEmail)
    {
        ...
        var link = urlHelper.PageLink("/ConfirmEmail",
            values: new { userId = user.Id, code = code, newEmail = newEmail })!;
