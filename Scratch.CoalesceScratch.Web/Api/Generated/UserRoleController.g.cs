...
namespace Scratch.CoalesceScratch.Web.Api
{
    ...
    public partial class UserRoleController
        : BaseApiController<Scratch.CoalesceScratch.Data.Models.UserRole, UserRoleParameter, UserRoleResponse, Scratch.CoalesceScratch.Data.AppDbContext>
    {
        public UserRoleController(CrudContext<Scratch.CoalesceScratch.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<Scratch.CoalesceScratch.Data.Models.UserRole>();
        }
        ...
        public virtual Task<ItemResult<UserRoleResponse>> Get(
            ...
            IDataSource<Scratch.CoalesceScratch.Data.Models.UserRole> dataSource)
        ...
        public virtual Task<ItemResult<UserRoleResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<Scratch.CoalesceScratch.Data.Models.UserRole> dataSource,
            IBehaviors<Scratch.CoalesceScratch.Data.Models.UserRole> behaviors)
